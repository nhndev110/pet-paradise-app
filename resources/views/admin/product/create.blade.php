                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <x-admin.input-text type="number" name="quantity" placeholder="Nhập số lượng"
                                                min="0" value="0" />
                                ...
                                <div class="form-group">
                                    ...
                                    <x-admin.input-textarea name="description" rows="5"
                                        placeholder="Nhập chi tiết sản phẩm" class="editor">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <x-admin.input-label name="image" value="Hình ảnh chính" required />
                                    <div class="input-group">
                        ...
                        $('#gallery-preview').append(`
                            <div class="col-md-4 mb-2">
                                <div class="position-relative">
                                    <a href="${e.target.result}" data-toggle="lightbox">
