                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        <button class="btn btn-info rounded-pill mr-1"
                            onclick="$('#positions-table').DataTable().ajax.reload();">
                            <i class="fas fa-sync-alt"></i>
                            <span class="ml-1">Làm mới</span>
                        </button>
                        <a href="{{ route('admin.positions.create') }}" class="btn btn-primary rounded-pill">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <x-admin.search-panel>
                        <form method="GET" action="{{ route('admin.positions.index') }}" id="search-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Tên chức vụ</label>
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name', request()->name) }}" placeholder="Nhập tên chức vụ" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
@push('scripts')
    ...
    <script>
        $(function() {
            $('#positions-table').on('submit', '.delete-form', function(e) {
                e.preventDefault();
