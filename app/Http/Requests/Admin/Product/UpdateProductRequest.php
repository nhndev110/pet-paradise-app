...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'thumbnail.image' => 'Trường hình ảnh phải là ảnh.',
            'thumbnail.mimes' => 'Trường hình ảnh phải là ảnh có định dạng: jpg, jpeg, png, gif.',
            'thumbnail.max' => 'Trường hình ảnh phải có dung lượng không quá 2MB.',
            ...
            'sku.required' => 'Trường mã SKU không được để trống.',
            'sku.string' => 'Trường mã SKU phải là chuỗi.',
            'sku.max' => 'Trường mã SKU không được vượt quá 50 ký tự.',
            'sku.unique' => 'Trường mã SKU phải là duy nhất.',
            'stock.required' => 'Trường số lượng không được để trống.',
            'stock.integer' => 'Trường số lượng phải là số nguyên.',
            'stock.min' => 'Trường số lượng phải ít nhất là 0.',
